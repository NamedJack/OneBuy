package wang.wongxd.wquicklib.utils.conf;
...
//    public static String HOST = "http://47.90.67.109:8083/";
    ...
    public static String IMGHOST = "http://192.168.102.7:8010";

    public static String HOST = "http://192.168.102.7:8010/";
     ...
     * 线上商城
     */
    public static String Shop_URL = HOST + "user/fSGoods/query";
     ...
     * 商城分类
     */
    public static String ShopCatalog_URL = HOST + "sjshop/front/catalog/list";


    /**
     * 商城商品列表
     */
    public static String ShopList_URL = HOST + "sjshop/front/product/list";


    /**
     * 商城商品详情
     */
    public static String GoodDetail_URL = HOST + "sjshop/front/product/queryById";


    /**
     * 商城商品规格
     */
    public static String GoodSpec_URL = HOST + "sjshop/front/product/queryParameter";


    /**
     * 添加到购物车
     */
    public static String AddToCart_URL = HOST + "sjshop/front/cart/insert";


    /**
     * 立即购买
     */
    public static String BuyNow_URL = HOST + "front/order/buyNow";


    /**
     * 收货地址列表
     */
    public static String AdressList_URL = HOST + "front/address/list";


    /**
     * 删除地址
     */
    public static String DeleteAdress_URL = HOST + "front/address/deleteAddress";


    /**
     * 编辑地址
     */
    public static String EditAdress_URL = HOST + "front/address/updateAddress";


    /**
     * 设置默认地址
     */
    public static String SetDefault_URL = HOST + "front/address/setDefault";


    /**
     * 新增收货地址
     */
    public static String AddAdress_URL = HOST + "front/address/insert";


    /**
     * 购物车列表
     */
    public static String CartList_URL = HOST + "sjshop/front/cart/list";


    /**
     * 批量修改购物车商品
     */
    public static String EditCarts_URL = HOST + "front/cart/updateCarts";


    /**
     * 批量删除 购物车
     */
    public static String DeleteCarts_URL = HOST + "sjshop/front/cart/deleteByIds";


    /**
     * 修改、删除 购物车
     */
    public static String ChangeCart_URL = HOST + "sjshop/front/cart/updateOrdelete";


    /**
     * 购物车结算
     */
    public static String SettleCart_URL = HOST + "front/cart/settleBuycar";


    /**
     * 提交订单
     */
    public static String SubmitOrder_URL = HOST + "front/order/submitOrder";


    /**
     * 订单列表
     */
    public static String OrderList_URL = HOST + "front/order/orderList";


    /**
     * 取消订单
     */
    public static String CancelOrder_URL = HOST + "front/order/cancel";


    /**
     * 确认收货
     */
    public static String ConfirOrder_URL = HOST + "front/order/confirm";

    /**
     * 立即支付
     */
    public static String PayNowOrder_URL = HOST + "front/order/payNow";

    /**
     * 订单详情
     */
    public static String OrderDetail_URL = HOST + "front/order/orderdetail";

    /**
     * 删除订单
     */
    public static String DeleteOrder_URL = HOST + "front/order/delete";
