package wang.wongxd.wquicklib.utils.location;
...
import wang.wongxd.wquicklib.bean.China;
import wang.wongxd.wquicklib.bean.ProvinceBean;
import wang.wongxd.wquicklib.utils.KeyboardUtil;
...
//                 System.out.println("provinceName==="+provinceName);
    ...
    //修改区域
    public static OptionsPickerView initRegionPicker(WeakReference<Activity> weakReference, final LocationCallback locationCallback) {

        KeyboardUtil.closeKeyboard(weakReference);
        ...
        OptionsPickerView pvOptions = new OptionsPickerView.Builder(weakReference.get(), new OptionsPickerView.OnOptionsSelectListener() {
            ...
            public void onOptionsSelect(int options1, int option2, int options3, View v) {
                ...
                if (locationCallback != null) {
                    locationCallback.getLocation(tx, province, city, area);
                }
...
//                .setLinkage(false)//设置是否联动，默认true
    ...
    public interface LocationCallback {
         ...
         * @param a 区
         */
        void getLocation(String location, String p, String c, String a);
    }
}
